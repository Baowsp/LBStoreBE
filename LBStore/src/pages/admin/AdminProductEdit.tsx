      ...
      <form onSubmit={handleSave} className="space-y-8">
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          <div className="p-8 space-y-6">
            ...
            <div>
              <label className="block text-xs font-bold text-gray-500 uppercase mb-2">Ảnh sản phẩm (Local)</label>
              <div className="flex items-center gap-6">
                ...
                <div className="flex-1">
                  <label className="inline-flex items-center gap-2 px-6 py-3 bg-white border border-gray-200 rounded-xl text-sm font-bold text-gray-700 cursor-pointer hover:bg-gray-50 transition-all shadow-sm">
                    <UploadCloud size={18} /> Thay đổi ảnh
            ...
            <div>
              ...
              <textarea rows={4} value={formData.description}
                ...
                className="w-full p-4 rounded-xl border border-gray-200 text-sm font-medium outline-none focus:ring-2 focus:ring-red-500 bg-white transition-all"
              />
            </div>
            ...
            <div>
              ...
              <textarea rows={6} value={formData.specs}
                ...
                className="w-full p-4 rounded-xl border border-gray-200 text-sm font-medium outline-none focus:ring-2 focus:ring-red-500 bg-white transition-all font-mono"
                        ...
                        <div className="mt-2 text-xs text-gray-500 bg-gray-50 p-2 rounded-lg">
                          ...
                          {c.replies.map(r => (
                            <div key={r.id} className="mt-1 flex justify-between">
                              ...
                              <button onClick={() => handleDeleteComment(r.id)} className="text-red-400 hover:text-red-600 ml-2" title="Xóa trả lời">
                                <Trash2 size={12} />
                              </button>
                            </div>
                          ))}
